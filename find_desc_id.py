...
Usage: python find_desc_id.py <target_desc_id>
"""
...
def main():
    if len(sys.argv) != 2:
        print("Usage: python find_desc_id.py <target_desc_id>")
        print("Example: python find_desc_id.py b0f35632-a0c6-4e52-ad97-36a7b5bdf65d")
        sys.exit(1)
